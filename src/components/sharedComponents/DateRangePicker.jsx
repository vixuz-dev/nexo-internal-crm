    ...
    <div className="flex flex-col sm:flex-row gap-4 items-end">
      <div className="flex-1">
        ...
        <input
          ...
          max={endDate || today}
          className="w-full px-4 py-2 border-2 border-neutral-500 rounded-lg bg-white text-black focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none"
        />
      </div>
      <div className="flex-1">
        <label className="block text-sm font-medium text-black mb-2 flex items-center gap-2">
